...
class OrdersHandlers(BaseHandler):
    ...
    def get(self):
        ...
        sql = "select O.order_number ,O.order_date,O.price,O.booking_num,O.unit_price,O.pay_type,O.booking_checkin_date,O.booking_leave_date,O.order_type,O.order_state,H.hotel_name,H.reception_phone,H.hotel_address, U.nick_name,U.phone_number from y_order_record_3 O left join y_hotel_info_8 H on O.hotel_Id=H.hotel_Id left join y_user_info_1 U on H.user_id=U.user_id    order by O.order_id DESC limit 0,10"
        try:
